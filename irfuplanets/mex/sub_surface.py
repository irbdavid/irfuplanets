...
def read_tec(start, finish=None, params=("EPHEMERIS_TIME", "TEC", "SZA")):
    """read_tec from marsis sub-surface dataset.  Start, finish are ets,
    position=True retains the various position columns in the tec files"""
    if finish is None:
        finish = start + 86400.0
